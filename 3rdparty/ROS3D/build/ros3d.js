...
ROS3D.DepthCloud = function(options) {
  ...
  // Projection matrix of the stereo camera
  this.P00 = options.P00 || 340.4;
  this.P02 = options.P02 || 327.4;
  this.P03 = options.P03 || -85.7;
  this.P12 = options.P12 || 193.4;
  this.laser_ylim = options.laser_ylim;
  this.zmax = options.zmax || 15.0;
